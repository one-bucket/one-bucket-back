...
//    private CreateChatRoomDto createChatRoomDto;
//
//    @BeforeEach
//    void setUp() {
...
//            createChatRoomDto = CreateChatRoomDto.of("chatroom1", LocalDateTime.now(),"username1",memberSet,10);
//        }
//    }
//
//    @Test
...
//
//    @Test
//    @DisplayName("채팅방 입장 - 너무 많은 유저의 접근이지만 10명만 허용")
//    void enterChatRoom_Concurrency_failure() throws InterruptedException {
//        String roomId = chatRoomService.createChatRoom(createChatRoomDto);
//
...
//                () -> new ChatRoomException(ChatErrorCode.NOT_EXIST_ROOM)
//        );
//        assertThat(chatRoom.getMembers().size()).isEqualTo(10);
//    }
//
//
//    @Test
