...
public record VerifiedCodeCheckDto(
    ...
    public static VerifiedCodeCheckDto of(String username,RequestCodeCheckDto dto) {
        return new VerifiedCodeCheckDto(username,dto.universityEmail(),dto.verifiedCode());
    }
}
